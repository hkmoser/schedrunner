...
/// DashboardActivityAttributes.ContentState (started by the app, updated via APNs push).
struct DashboardLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: DashboardActivityAttributes.self) { context in
...
struct LockScreenLiveActivityView: View {
    let state: DashboardActivityAttributes.ContentState
    let title: String
