    ...
    @ViewBuilder private var content: some View {
        ...
        case .tooNew:
            MessageView(title: "Update needed",
                        detail: "This __APP_NAME_LOWER__ shell is older than the server. Update the app.")
        case .ok:
            if let manifest = vm.current {
                ...
                MessageView(title: "Offline",
                            detail: "Can't reach the __APP_NAME_LOWER__ and there's nothing cached yet.")
            } else {
