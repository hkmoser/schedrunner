...
final class ActivityManager {
    ...
    private var current: Activity<__APP_NAME__ActivityAttributes>?
    ...
    private init() {
        ...
        if let existing = Activity<__APP_NAME__ActivityAttributes>.activities.first {
            current = existing
    ...
    @discardableResult
    func start(_ state: __APP_NAME__ActivityAttributes.ContentState, title: String = "Activity") -> StartResult {
        ...
        do {
            let activity = try Activity.request(
                attributes: __APP_NAME__ActivityAttributes(title: title),
    ...
    func update(_ state: __APP_NAME__ActivityAttributes.ContentState) {
    ...
    private func observeToken(of activity: Activity<__APP_NAME__ActivityAttributes>) {
        Task {
