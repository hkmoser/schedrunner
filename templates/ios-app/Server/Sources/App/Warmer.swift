...
enum Warmer {
    ...
    /// uses (nil = the default __APP_NAME_LOWER__ screen). `expensive` = BigQuery-backed; those are
    ...
    static func targets() -> [Target] {
        [
            // __APP_NAME__: weather / stocks / mortgage / property — cheap external APIs.
    ...
    static func start(on app: Application) {
        ...
        let bqInterval = app.__APP_NAME_LOWER__Config.warmBQInterval
