...
func widgetProviderData(_ req: Request, _ provider: DataProvider) async -> JSONValue {
    let cfg = req.application.__APP_NAME_LOWER__Config
...
public func routes(_ app: Application) throws {
    ...
    app.get("__APP_NAME_LOWER__") { req async -> Manifest in
        var config = req.application.__APP_NAME_LOWER__Config
    ...
    app.get("widget", "activity") { req async -> WidgetActivityResponse in
        ...
        let sidecar = req.application.__APP_NAME_LOWER__Config.bqSidecarURL
    ...
    app.get("test_push") { req async -> Response in
        ...
        let payload: [String: Any] = ["aps": ["alert": ["title": "__APP_NAME__", "body": "Test push — it works ✅"], "sound": "default"]]
